...
export const Hero = () => {
  ...
  return (
    <section className="relative h-screen min-h-[600px] max-h-[750px] flex flex-col justify-end overflow-hidden md:m-16 md:mb-10 md:mt-0 p-1 rounded-t-md md:rounded-md md:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.5)]">
