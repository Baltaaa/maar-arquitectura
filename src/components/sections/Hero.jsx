...
export const Hero = () => {
  ...
  return (
    <section className="relative select-none h-[85vh] md:h-screen min-h-[300px] max-h-[750px] flex flex-col justify-end overflow-hidden md:m-16 md:mb-10 md:mt-0 p-1 rounded-t-[15px] md:rounded-[15px] md:shadow-[0_20px_80px_-20px_rgba(0,0,0,0.5)]">
